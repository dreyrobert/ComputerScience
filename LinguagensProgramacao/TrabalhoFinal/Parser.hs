...
happyExpList = Happy_Data_Array.listArray (0,198) ([52768,16452,0,0,0,9855,2,0,0,34816,4403,0,0,64,40000,32905,4920,32513,1574,52478,4,32,14328,17,0,52768,16452,35228,14464,275,0,4096,0,48,34816,4403,0,26,0,40000,137,7,0,16,16384,3,0,0,61440,8823,52768,68,1024,14464,275,0,0,832,56,8,512,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","Type","num","'+'","\"&&\"","\"==\"","true","false","if","then","else","var","'\\\\'","':'","\"->\"","'('","')'","Bool","Number","try","with","%eof"]
